...
class BookingController extends ChangeNotifier {
  ...
  int _searchStatus = Booking.all;
  
  int get searchStatus => _searchStatus;
  ...
  */
  ...
  /*
  * Get all booking for status
  * @author SGV
  * @version 1.0 - 20230215 - initial release
  * @return  all event saved
  */
  Future<List> getAllBookingForStatus(int status) async{
    List allContacts = [];
    Map<String, dynamic> parameters = {
      'action': 'getAllBookingForStatus',
